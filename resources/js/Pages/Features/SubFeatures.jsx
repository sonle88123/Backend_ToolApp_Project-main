...
const handleParentChange1 = (id, value) => {
  if (value != null) { // Check if the value is not '0'
    axios.put(`/sub_feature/${id}`, { feature_id: value })
      .then((res) => {
  ...
  const columns = [
    ...
    {
      field: 'feature_id', headerName: "Nhóm feature", width: 200, renderCell: (params) => (
        <Select
      ...
      <>
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            ...
            <select name="" defaultValue={featureId} onChange={(e)=>setFeatureId(e.target.value)} className='form-control mt-2' id="">
              <option value={0} disabled>Chọn Feature phụ thuộc</option>
